...
## Extended practice: multi-round, high-stakes decisions (e.g. job offer A vs B)

For decisions big enough to run 5+ rounds (career moves, major purchases, irreversible commitments), the base loop above isn't enough on its own. Layer in the following, learned from a real multi-round grilling session (Volaris vs Bluefish offer decision, 2026-07-18):
